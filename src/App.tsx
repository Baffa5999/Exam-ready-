...
export default function App() {
  ...
  const renderProfilePage = () => {
    ...
    return (
      <div className="min-h-dvh bg-[#0B1324] font-sans text-white">
        <main className="mx-auto flex max-w-lg flex-col px-4 pb-28 pt-5 animate-fade-up sm:px-6">
          ...
          <div className="flex items-center justify-between">
            <button
              ...
              className="inline-flex items-center gap-1.5 font-sans text-sm font-medium text-[#8B9CB8] transition hover:text-white"
            >
          ...
          <div className="mt-8 flex flex-col items-center text-center">
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #2EC4B6 0%, #0EA5E9 100%)', padding: '3px' }}
            >
              <div className="flex h-full w-full items-center justify-center rounded-full bg-[#0B1324]">
                <span className="font-heading text-3xl font-bold text-white">{initial}</span>
              </div>
            </div>
            <h1 className="mt-4 font-heading text-xl font-bold tracking-tight text-white">{username}</h1>
            <p className="mt-1 font-sans text-sm text-[#8B9CB8]">{email}</p>
            <button
              type="button"
              className="mt-4 rounded-full border border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.05)] px-5 py-2 font-sans text-sm font-medium text-[#C8D2E4] transition hover:border-[rgba(255,255,255,0.22)] hover:text-white"
            >
              Edit Profile
            </button>
          </div>
          ...
          {/* Divider */}
          <div className="mt-8 border-t border-[rgba(255,255,255,0.06)]" />

          {/* Stats */}
          <div className="mt-6">
            <p className="mb-3 font-sans text-[11px] font-semibold uppercase tracking-widest text-[#8B9CB8]">Your Stats</p>
            <div className="flex flex-col gap-3">
              {profileStats.map(({ label, value, Icon, accent, bg }) => (
                <div
                  key={label}
                  className="flex items-center gap-4 rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#111827] px-4 py-4"
                >
                  <div
                  ...
                  <p className="flex-1 font-sans text-sm font-medium text-[#C8D2E4]">{label}</p>
